...
{
    public class PasswordResetPolicy : IPasswordResetPolicy
    {
        private readonly PasswordResetOptions _options;

        public PasswordResetPolicy(IOptions<AuthOptions> authOptions)
        {
            _options = authOptions.Value.PasswordReset ?? new PasswordResetOptions();
        }
